...
ok('Stand 78 von 101', (await page.textContent('#count')).trim()==='78 von 101', await page.textContent('#count'));
...
ok('Zeigt an, womit gestartet wird', /Starte mit 23 Orten/.test(log));
