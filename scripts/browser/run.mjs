...
const alle = readdirSync(here)
  /* fixture.mjs ist gemeinsamer Datensatz und startfrei.mjs ein Helfer,
     beides keine Suiten -- ohne diese Zeile startet der Laeufer sie und
     meldet je eine Suite ohne Ergebnis. */
